package com.ftn.isa4.config;

import com.ftn.isa4.security.TokenUtils;
import com.ftn.isa4.security.auth.RestAuthenticationEntryPoint;
import com.ftn.isa4.security.auth.TokenAuthenticationFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity web) throws Exception {
        web.ignoring().antMatchers(HttpMethod.POST, "/auth/login", "/center/search");
